...
//private ComboBox com_vendedor;
 ...
 private PanelInventarioM padreM;
...
public MostraVenta(Object[][] clienteM1, Object[][] vendedorM1, String idmarca, String responsable,PanelInventario panel)
{
       this.padre = panel;
...
//desde panelinventario m
   public MostraVenta(Object[][] clienteM1, Object[][] vendedorM1, String idmarca, String responsable,PanelInventarioM panelM)
{
       this.padreM = panelM;
         this.clienteM = clienteM1;
           this.vendedorM = vendedorM1;
...
formPanelCliente.add(com_vendedor);
 formPanelCliente.add(com_cliente);
         ...
         add(formPanelCliente);
anadirListenersTexfieldM();
        addListenersM();

    }

private void anadirListenersTexfieldM() {
...
//    }
            if ((!idvendedor.isEmpty()) && (!idcliente.isEmpty())) {
                 padreM.registrarventa(idvendedor,idcliente,fecha,boletamanual);
            }else{
