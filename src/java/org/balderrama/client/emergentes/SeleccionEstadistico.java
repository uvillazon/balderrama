 ...
 * @author 
 */
public class SeleccionEstadistico extends Window {
...
//desde ccabecera
  ...
  public SeleccionEstadistico(String mesper,String fechaini,String fechaf,Object[][] kardex,Object[][] almacen, KMenu kmenu) {
        padre=kmenu;
        kardexM = kardex;
        almacenM =almacen;
        ...
        mesperiodo=mesper;
        //kmenu = menu;
        String tituloTabla = "Estadistico";
        this.setClosable(true);
        this.setId("TPfun1104");
        setIconCls("tab-icon");
        setAutoScroll(true);
...
//recapitulacion general
         but_editar1 = new Button("Informe por Almacen", new ButtonListenerAdapter() {
            @Override
     ...
     GuardarEditarCliente(e);
      ...
      but_cancelarP = new Button("Cancelar", new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                SeleccionEstadistico.this.destroy();
                SeleccionEstadistico.this.close();
              }
        });
        com_kardex = new ComboBox("Inf Buscar", "kardex");

       com_estilo = new ComboBox("Almacen", "almacen");
...
//   addButton(but_nacresumen);
 ...
 private void initvalues() {
    ...
    public void GuardarEditarCliente(EventObject e) {
                ...
                PanelEstadistico1 pan_compraDirecta = new PanelEstadistico1(SeleccionEstadistico.this,panel,padre);
                                  //  PanelCobrosEmpresa pan_compraDirecta = new PanelCobrosEmpresa(idempresa, codigo, nombre, responsable, comision, planilla,mes1,mes2,mes3, vendedores, cobro1,cobro2,cobro3,cobro11,cobro22,cobro33,mesanio1,mesanio2,mesanio3,mesanio4,mesanio5,mesanio6, ConsultaEmpresa.this,panel);
                                    padre.seleccionarOpcion(null, "fun11041", e, pan_compraDirecta);
                                    // PanelEstadistico1 pan_compraDirecta = new PanelEstadistico1();
                                    // pan_compraDirecta.onModuleLoad();
                                    SeleccionEstadistico.this.clear();
                                    SeleccionEstadistico.this.close();
    }
