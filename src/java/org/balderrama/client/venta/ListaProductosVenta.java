 ...
 * @author example
 */
public class ListaProductosVenta {
...
//    private ColumnConfig precioColumn;
  //  String[] nombreComlumns = {"idkardexunico", "idmodelo", "modelo","detalle","talla", "item","cantidad", "preciou","preciocaja","vendedor"};
  ...
  //      tallaColumn = new ColumnConfig("Talla", nombreComlumns[4], 50, true);
   //    itemColumn = new ColumnConfig("Item", nombreComlumns[5], 80, true);
        cantidadColumn = new ColumnConfig("Cantidad", nombreComlumns[4], 80, true, null);
        precioColumn = new ColumnConfig("Precio U", nombreComlumns[5], 90, true, null);
