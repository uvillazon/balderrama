 ...
 * @author 
 */
public class SeleccionAlmacenRecapitula extends Window {
...
//desde ccabecera
  ...
  public SeleccionAlmacenRecapitula(String mesper,String fechaini,String fechaf,Object[][] kardex,Object[][] almacen, KMenu kmenu) {
        padre=kmenu;
        kardexM = kardex;
        almacenM =almacen;
        ...
        mesperiodo=mesper;
        //kmenu = menu;
        String tituloTabla = "Recapitulacion";
        this.setClosable(true);
        this.setId("TPfun1101");
        setIconCls("tab-icon");
        setAutoScroll(true);
...
//recapitulacion general
         but_editar1 = new Button("RECAPITULACION * Almacen", new ButtonListenerAdapter() {
            @Override
      ...
      String enlace = "funcion=VerRecapitulacionMarcaAlmacen&idalmacen=" + idmarca + "&idestilo="+idestilo+ "&idkardex="+idkardex+ "&fechainicio="+fechainicio+ "&fechafin="+fechafin;
      ...
      but_cancelarP = new Button("Cancelar", new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                SeleccionAlmacenRecapitula.this.destroy();
                SeleccionAlmacenRecapitula.this.close();
              }
        });
