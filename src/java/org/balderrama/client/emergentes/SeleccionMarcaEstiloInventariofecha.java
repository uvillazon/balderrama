 ...
 * @author 
 */
public class SeleccionMarcaEstiloInventariofecha extends Window {
  ...
  //   private Button but_reporte;
    ...
    private Button but_trainte;
        private Button but_habilita;
         private Button but_bitacora;
   //  private Button but_general;
     //    private Button but_generalmarca;
        private Button but_rebajaprecios;
    private Button but_traspasocatalogo;
private Button but_traspaso;
  ...
  //  Pedido ped;
   ...
   private DateField dat_fechaini1109;
    ...
    public SeleccionMarcaEstiloInventariofecha(Object[][] marca,Object[][] estilo, KMenu kmenu) {
        padre=kmenu;
      //  panel=pan;
        ...
        vendedorM =estilo;
        //kmenu = menu;
        String tituloTabla = "Reportes de Entradas y Salidas de Inventario";
        this.setClosable(true);
        this.setId("TPfun2304");
        setIconCls("tab-icon");
        setAutoScroll(false);
  ...
  dat_fechaini1109 = new DateField("Fecha Inicio", "Y-m-d",200);
      ...
      //    String nombreBoton3 = "Ventas Gral";
        ...
        String nombreBoton222 = "Eliminaciones";
  ...
  String nombreBoton41 = "Trasp Recibidos";
       String nombreBoton42 = "Trasp inter REc";
        String nombreBoton421 = "Trasp inter Env";
        String nombreBoton43 = "HABILITACIONES";
          String rebajaprecios = "REBAJA PRECIOS";
          String traspasocatalogo = "TRASPASO CATALOGO";
        formPanel = new FormPanel();
        formPanel.setBaseCls("x-plain");
        //formPanel.setLabelWidth(ANCHO - 400);

        but_traspaso = new Button(nombreBoton34, new ButtonListenerAdapter() {
            @Override
      ...
      but_rebaja = new Button(nombreBoton41, new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                 String idmarca = com_marca.getValue();
        String idestilo = com_estilo.getValue();
         String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
           String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
        String enlace = "funcion=vertraspasomarcarecib&idmarca=" + idmarca + "&idestilo="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
               verReporte(enlace);
            }
        });
 but_traint = new Button(nombreBoton42, new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                 String idmarca = com_marca.getValue();
        String idestilo = com_estilo.getValue();
         String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
           String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
        String enlace = "funcion=vertraspasointerno&idmarca=" + idmarca + "&idestilo="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
               verReporte(enlace);
       //          String enlace = "funcion=vertraspasomarcarecib&idmarca=" + idmarca + "&idestilo="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
       //        verReporte(enlace);
            }
        });
         but_trainte = new Button(nombreBoton421, new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                 String idmarca = com_marca.getValue();
        String idestilo = com_estilo.getValue();
         String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
           String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
        String enlace = "funcion=vertraspasointernoenviado&idmarca=" + idmarca + "&idestilo="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
               verReporte(enlace);
       //          String enlace = "funcion=vertraspasomarcarecib&idmarca=" + idmarca + "&idestilo="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
       //        verReporte(enlace);
            }
        });
         but_habilita = new Button(nombreBoton43, new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                 String idmarca = com_marca.getValue();
        String idestilo = com_estilo.getValue();
         String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
           String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
        String enlace = "funcion=habilitaciones&idmarca=" + idmarca + "&idestilo="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
               verReporte(enlace);
       //          String enlace = "funcion=vertraspasomarcarecib&idmarca=" + idmarca + "&idestilo="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
       //        verReporte(enlace);
            }
        });
  but_bitacora = new Button(nombreBoton222, new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                 String idmarca = com_marca.getValue();
        String idestilo = com_estilo.getValue();
         String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
           String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
        String enlace = "funcion=eliminacionesbit&idmarca=" + idmarca + "&idestilo="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
               verReporte(enlace);
       //          String enlace = "funcion=vertraspasomarcarecib&idmarca=" + idmarca + "&idestilo="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
       //        verReporte(enlace);
            }
        });
        but_ingresos = new Button(nombreBoton31, new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                  String idmarca = com_marca.getValue();
        String idestilo = com_estilo.getValue();
         String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
           String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
       String enlace = "funcion=veringresolistamarca&idmarca=" + idmarca + "&idvendedor="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
               verReporte(enlace);
            }
        });
         but_ingresosinventario = new Button(nombreBoton313, new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                  String idmarca = com_marca.getValue();
        String idvendedor = com_estilo.getValue();
         String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
           String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
       String enlace = "funcion=veringresomarcavendedor&idmarca=" + idmarca + "&idvendedor="+ idvendedor +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
      //  String enlace = "funcion=veringresolistamarca&idmarca=" + idmarca + "&idvendedor="+ idvendedor +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
 ...
 but_reportemodelo = new Button(nombreBoton44, new ButtonListenerAdapter() {
       ...
       String enlace = "funcion=verventalistamarcamodelo&idmarca=" + idmarca + "&idvendedor="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
         ...
         but_rebajaprecios = new Button(rebajaprecios, new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                 String idmarca = com_marca.getValue();
        String idestilo = com_estilo.getValue();
         String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
           String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
       String enlace = "funcion=verrebajasinventario&idmarca=" + idmarca + "&idvendedor="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
               verReporte(enlace);
           }
        });

          but_traspasocatalogo = new Button(traspasocatalogo, new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                 String idmarca = com_marca.getValue();
        String idestilo = com_estilo.getValue();
         String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
           String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
       String enlace = "funcion=vertraspasocatalogo&idmarca=" + idmarca + "&idvendedor="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
               verReporte(enlace);
           }
        });
...
//  com_estilo.setDisabled(true);
     ...
     //   addButton(but_devolucion);
       ...
       addButton(but_traint);
        addButton(but_trainte);
   addButton(but_habilita);
    addButton(but_rebajaprecios);
        addButton(but_traspasocatalogo);
   addButton(but_traspasocatalogo);
      addButton(but_bitacora);
