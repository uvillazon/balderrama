 ...
 * @author
 */
class MostrarEditarModeloitem extends Window {
...
String montos;
 public RadioButton facturaSi;
    ...
    public MostrarEditarModeloitem(Object[][] vendedorM1, PanelInventarioM panell)
{  this.padre2 = panell;
   ...
   this.vendedorM = vendedorM1;
     String tituloTabla ="Edicion";
       String nombreBoton1 = "Registrar";
        ...
        setId("win-NuevaEmpresaForm-traspaso-l");
     ...
     //   addButton(but_aceptarv);
        ...
        tex_cliente = new TextField("CLIENTE/ITEM", "cliente",150);
...
initValues();
     ...
     public MostrarEditarModeloitem(Object[][] vendedorM1, PanelInventario panell2)
{  this.padre = panell2;
...
private void anadirListenersTexfield() {
 ...
 private void addListeners2() {
       but_aceptar.addListener(new ButtonListenerAdapter() {
         ...
         padre2.registraredicionmodeloitem(item,clientem);
     ...
     private void addListeners() {
       but_aceptar.addListener(new ButtonListenerAdapter() {
            ...
            public void onClick(Button button, final EventObject e) {
              ...
              String item = tex_cliente.getValueAsString();
           String clientem = com_cliente.getValueAsString();
         padre.registraredicionmodeloitem(item,clientem);
