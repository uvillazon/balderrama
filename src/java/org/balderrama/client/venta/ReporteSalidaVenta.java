 ...
 * @author Haydee
 */
import org.balderrama.client.util.*;
...
public class ReporteSalidaVenta extends Window {
    ...
    public ReporteSalidaVenta(String enlace) {
        setTitle("Reporte");
    ...
    public ReporteSalidaVenta(String enlace, String reporte) {
        setTitle("Reporte");
...
//        this.enlaceReportePDF = "php/ReportePDF.php?" + enlace;
    ...
    public ReporteSalidaVenta(String enlace, boolean vistaPrevia) {
        setTitle("Reporte");
    ...
    private void onModuleLoad1() {
        ...
        but_cancelarP = new Button(nombreBoton2, new ButtonListenerAdapter() {
            ...
            public void onClick(Button button, EventObject e) {
                ...
                ReporteSalidaVenta.this.destroy();
                ReporteSalidaVenta.this.close();
                ReporteSalidaVenta.this.clear();
