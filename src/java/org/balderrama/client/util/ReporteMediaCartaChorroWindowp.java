...
public class ReporteMediaCartaChorroWindowp extends Window {

    private final int ANCHOClienteWin = 200;
    private final int ALTOClienteWin = 200;
...
//    private Panel panel;
    ...
    public ReporteMediaCartaChorroWindowp(String enlace) {
        setTitle("Reporte");
    ...
    public ReporteMediaCartaChorroWindowp(String enlace, boolean vistaPrevia) {
        setTitle("Reporte");
