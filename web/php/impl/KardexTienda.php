...
function getSqlNewCodigonumeracionmarca($idcodigonumeracion, $idcoleccion, $idmarca, $codigobarra, $return){
$setC[0]['campo'] = 'idcodigonumeracion';
$setC[0]['dato'] = $idcodigonumeracion;
$setC[1]['campo'] = 'idcoleccion';
$setC[1]['dato'] = $idcoleccion;
...
$setC[3]['dato'] = $codigobarra;
$sql2 = generarInsertValues($setC);
return "INSERT INTO codigonumeracionmarca ".$sql2;
}
...
FROM
  `codigocoleccion` cco
WHERE
  cco.idmarca = '$idmarca' order by(cco.idcodigocoleccion) DESC limit 1
";
...
function ObtenerCodigoBarraMarcaDetalleAdicion($idmarca , $idcoleccion,$return){
    $dev['error'] = "false";
    $dev['mensaje'] = "";
...
WHERE
  con.idcoleccion = '$idcoleccion' AND con.idmarca = '$idmarca'";
    ...
    $dato = $codigomarca.$codigocoleccion.$codigonumeracion;
  //  echo $dato;
        $sql[] = getSqlNewCodigonumeracionmarca($idcodigonumeracion, $idcoleccion, $idmarca,$codigonumeracion, false);
// MostrarConsulta($sql);
if(ejecutarConsultaSQLBeginCommit($sql)){
...
function getSqlNewAdicionkardextienda($idkardextienda, $idmodelodetalle, $idtienda, $codigobarra, $saldocantidad, $cantidad, $numero, $talla, $precio1bs, $precio2bs, $precio3bs, $precio1sus, $precio2sus, $precio3sus, $idcalzado, $idoperacion, $codigobarraean13, $generado, $return){
$setC[0]['campo'] = 'idkardextienda';
$setC[0]['dato'] = $idkardextienda;
$setC[1]['campo'] = 'idmodelodetalle';
$setC[1]['dato'] = $idmodelodetalle;
...
$setC[16]['campo'] = 'codigobarraean13';
$setC[16]['dato'] = $codigobarraean13;
$setC[17]['campo'] = 'generado';
$setC[17]['dato'] = $generado;
$sql2 = generarInsertValues($setC);
return "INSERT INTO adicionkardextienda ".$sql2;
}
function getSqlNewIngresokardextienda($idkardextienda, $idmodelodetalle, $idtienda, $codigobarra, $saldocantidad, $cantidad, $numero, $talla, $precio1bs, $precio2bs, $precio3bs, $precio1sus, $precio2sus, $precio3sus, $idcalzado, $idoperacion, $codigobarraean13, $generado, $return){
$setC[0]['campo'] = 'idkardextienda';
$setC[0]['dato'] = $idkardextienda;
$setC[1]['campo'] = 'idmodelodetalle';
$setC[1]['dato'] = $idmodelodetalle;
...
$setC[17]['dato'] = $generado;
$sql2 = generarInsertValues($setC);
return "INSERT INTO ingresokardextienda ".$sql2;
}

function getSqlNewHistorialkardextienda($idkardextienda, $idmodelodetalle, $idtienda, $codigobarra, $saldocantidad, $cantidad, $numero, $talla, $precio1bs, $precio2bs, $precio3bs, $precio1sus, $precio2sus, $precio3sus, $idcalzado, $idoperacion, $codigobarraean13, $generado, $return){
$setC[0]['campo'] = 'idkardextienda';
$setC[0]['dato'] = $idkardextienda;
$setC[1]['campo'] = 'idmodelodetalle';
$setC[1]['dato'] = $idmodelodetalle;
...
$setC[17]['dato'] = $generado;
$sql2 = generarInsertValues($setC);
return "INSERT INTO historialkardextienda ".$sql2;
}

function getSqlNewAdicionMovimientokardextienda($idmovimientokardextienda, $idkardextienda, $idtienda, $entrada, $salida, $saldo, $costounitario, $ingreso, $egreso, $saldobs, $fecha, $hora, $descripcion, $numero, $saldocantidad, $return){
    $setC[0]['campo'] = 'idmovimientokardextienda';
    $setC[0]['dato'] = $idmovimientokardextienda;
    $setC[1]['campo'] = 'idkardextienda';
    $setC[1]['dato'] = $idkardextienda;
