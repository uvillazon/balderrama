...
public class ListaColorSimple {
    ...
    public ListaColorSimple(String ancho, String alto) {
        this.ANCHO = ancho;
        this.ALTO = alto;

    }

    public ListaColorSimple(){

    }

    public void onModuleLoad() {
        panel = new Panel();
        dataProxy = new ScriptTagProxy("php/Colores.php?funcion=ListarColores");
        ...
        idcolorColumn = new ColumnConfig("IdColor", "idcolor", 100, false);
        ...
        pagingToolbar.setEmptyMsg("No existen colores para mostar");
