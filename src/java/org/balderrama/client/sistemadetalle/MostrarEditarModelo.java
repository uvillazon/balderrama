 ...
 * @author
 */
class MostrarEditarModelo extends Window {
 ...
 private Object[][] productoM;
    ...
    public TextField tex_modelo;
     public TextField tex_material;
      public TextField tex_color;
...
// MostrarEditarModelo(String idmodelo, String codigo, String color, String material, String cliente, String idcliente, String fechaingreso, String nombrecliente, Object[][] vendedorM, PanelInventario aThis) {
...
public MostrarEditarModelo(String idmodelo, String codigo, String color, String material, String cliente, String idcliente, String fechaingreso, String nombrecliente, Object[][] vendedorM1, PanelInventario panel)
{  this.padre = panel;
   ...
   this.fechaingreso =fechaingreso ;
    ...
    String tituloTabla ="Edicion";
     ...
     //   addButton(but_aceptarv);
        ...
        tex_modelo = new TextField("MODELO", "totalmonto" ,150);
        tex_material = new TextField("MATERIAL", "comision", 150);
        tex_color = new TextField("COLOR", "recibo",150);
        tex_fecha = new TextField("FECHA INGRESO", "recibo",150);
        tex_cliente = new TextField("CLIENTE", "recibo",150);


com_cliente = new ComboBox("Cleinte Asignado", "idcliente");
     //  initValues1();

 formPanelCliente.add(tex_modelo);
 formPanelCliente.add(tex_material);
 formPanelCliente.add(tex_color);
 formPanelCliente.add(tex_fecha);
 formPanelCliente.add(tex_cliente);
...
initValues();
    ...
    public MostrarEditarModelo(String idmodelo, String codigo, String color, String material, String cliente, String idcliente, String fechaingreso, String nombrecliente, Object[][] vendedorM1, PanelInventarioM panell)
{  this.padre2 = panell;
...
private void anadirListenersTexfield() {
 tex_modelo.addListener(new TextFieldListenerAdapter() {
     ...
     tex_material.addListener(new TextFieldListenerAdapter() {
         ...
         tex_fecha.addListener(new TextFieldListenerAdapter() {
            @Override
            public void onSpecialKey(Field field, EventObject e) {
                if (e.getKey() == EventObject.ENTER) {
                  tex_cliente.focus();
 ...
 tex_cliente.addListener(new TextFieldListenerAdapter() {
    ...
    private void addListeners() {
       but_aceptar.addListener(new ButtonListenerAdapter() {
           ...
           String material = tex_material.getValueAsString();
            String color = tex_color.getValueAsString();
             String fecha = tex_fecha.getValueAsString();
              String item = tex_cliente.getValueAsString();
           String clientem = com_cliente.getValueAsString();
...
//          String idalmacen = com_cliente1.getValueAsString();
         ...
         padre2.registraredicionmodelo(idmodelo,modelo,material,color,fecha,item,clientem);
 ...
 private void initValues() {
                      ...
                      tex_modelo.setValue(codigo);
                      tex_material.setValue(material);
                         tex_color.setValue(color);
                            tex_cliente.setValue(cliente);
                               tex_fecha.setValue(fechaingreso);
                                  tex_cliente.setValue(cliente);
  SimpleStore proveedorStore123 = new SimpleStore(new String[]{"idcliente", "codigo"}, vendedorM);
