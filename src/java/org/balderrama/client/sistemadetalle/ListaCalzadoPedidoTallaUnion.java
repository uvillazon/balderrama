 ...
 * @author example
 */
public class ListaCalzadoPedidoTallaUnion {

    private EditorGridPanel grid;
   // private final int ALTO = 355;
     private final int ALTO = 195;
 ...
 //   private ColumnConfig totalcajasColumn;
   ...
   // String[] nombreCaso33Columns = {"iddetalleingreso", "codigo", "color", "precio", "05", "50", "06", "60", "07", "70", "08", "80", "09", "90", "10",  "totalpares"};
...
//   String[] nombreCaso33Columns = {"iddetalleingreso", "codigo", "color", "precio", "1", "01", "02", "20", "03", "30", "04", "40", "05", "50", "06", "60", "07", "70", "08", "80", "09", "90", "10", "100", "11", "110", "12", "120", "13","130", "totalpares"};
...
//        grid.setHeight(ALTO);
//
//        grid.setTitle("Lista de Modelos " + nombremarca);
//        grid.setStore(store);
