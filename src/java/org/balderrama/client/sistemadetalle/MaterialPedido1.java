...
public class MaterialPedido1 extends Window {
    ...
    public MaterialPedido1(Object[][] materialM, ListaCalzadoPedido padre, int col, int row) {
        ...
        but_cancelarP = new Button(nombreBoton2, new ButtonListenerAdapter() {
            ...
            @Override
            public void onClick(Button button, EventObject e) {
                MaterialPedido1.this.close();
                MaterialPedido1.this.destroy();
                MaterialPedido1.this.setModal(false);
            //formulario = null;
            }
        });
