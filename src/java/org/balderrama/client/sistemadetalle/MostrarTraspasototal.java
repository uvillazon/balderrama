 ...
 * @author
 */
class MostrarTraspasototal extends Window {
...
public MostrarTraspasototal(Object[][] almacenM1, Object[][] vendedorM1, String idmarca, String responsable,PanelInventario panel)
{  this.padre = panel;
   this.almacenM = almacenM1;
   this.vendedorM = vendedorM1;
    this.tipoenvioM = new String[]{"TRASPASO -Marcas"};
    String tituloTabla ="Detalle TRaspaso";
     //  padre=panel;
       String nombreBoton1 = "Registrar";
        String nombreBoton2 = "Cancelar";
       // String nombreBoton3 = "Eliminar Empresa";

        setId("win-NuevaEmpresaForm-traspaso");
...
dat_fecha1 = new DateField("Fecha", "d-m-Y");
 ...
 dat_fecha1.setReadOnly(true);
         ...
         tex_codigoBarra = new TextField("Responsable", "totalmonto" ,100);
          tex_codigoC = new TextField("N Guia", "comision", 100);

        tex_nombreC = new TextField("Numero Boleta", "recibo",60);

com_cliente = new ComboBox("Vendedor al que enviamos", "idempleado");
//com_cliente1 = new ComboBox("Almacen de envio", "idalmacen");
...
//  formPanelCliente.add(com_cliente1);
...
//para 361
  public MostrarTraspasototal(Object[][] almacenM1, Object[][] vendedorM1, String idmarca, String responsable,PanelInventarioM panel)
{
  this.padre2 = panel;
         this.almacenM = almacenM1;
           this.vendedorM = vendedorM1;
this.tipoenvioM = new String[]{"TRASPASO"};
    String tituloTabla ="Detalle TRaspaso";
     //  padre=panel;
       String nombreBoton1 = "Registrar";
        String nombreBoton2 = "Cancelar";
       ...
       but_aceptar2 = new Button(nombreBoton1);
        but_cancelar2 = new Button(nombreBoton2);
     //   addButton(but_aceptarv);
        addButton(but_aceptar2);
        addButton(but_cancelar2);
...
private void anadirListenersTexfield2() {
 tex_nombreC.addListener(new TextFieldListenerAdapter() {
            @Override
            public void onSpecialKey(Field field, EventObject e) {
                if (e.getKey() == EventObject.ENTER) {
 ...
 tex_codigoC.addListener(new TextFieldListenerAdapter() {
    ...
    String boleta = tex_nombreC.getValueAsString();
        String responsable = tex_codigoBarra.getValueAsString();
        String numguia = tex_codigoC.getValueAsString();
         String idvendedor = com_cliente.getValueAsString();
//          String idalmacen = com_cliente1.getValueAsString();
           String fecha =dat_fecha1.getValueAsString();
           String tipo =com_tipo.getValueAsString();
//padre2.registrartraspasom(boleta,numguia,responsable,idvendedor,fecha,tipo);
   if ((idvendedor.equalsIgnoreCase(""))||(idvendedor == null)|| (idvendedor.equalsIgnoreCase("Buscar vendedor"))||(idvendedor.isEmpty()))
       {
                MessageBox.alert("Registre el nombre del Vendedor al que envia correctamente");

        } else {
         padre2.registrartraspaso(boleta,numguia,responsable,idvendedor,fecha,tipo);
           }
                    // padre.verdetalletraspaso(totalpares,totalcaja,totalbs);
            }
        });
...
//          String idalmacen = com_cliente1.getValueAsString();
         ...
         if ((idvendedor.equalsIgnoreCase(""))||(idvendedor == null)|| (idvendedor.equalsIgnoreCase("Buscar vendedor"))||(idvendedor.isEmpty()))
       {
         ...
         padre.registrartraspaso(boleta,numguia,responsable,idvendedor,fecha,tipo);
           }
         }
      });
