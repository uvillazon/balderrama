...
//conectar();
$sql1="select nombre from almacenes";
		$serv=consultaDB($sql1);
		$row=mysql_fetch_array($serv);
        $tienda=$row['0'];


//include("php/impl/UsuarioDAO.php");
include("php/bd/bd.php");
...
<script type="text/javascript" src="js/jscapslock.js"></script>
    ...
    {
        echo "<img src='php/GenerarCodigoGrafico.php' style='width:60px; height: 17px;' border='1' alt='C' align='left'></img><input type='text' name='CodigoGraficoVerificar' id='CodigoGraficoVerificar' style='width: 70px;font-size:12px; border: solid 1px #000000; height: 17px;' maxlength='6'>";
    }
//    echo "----".$_SESSION["intentos"]."----";
    ...
    echo "<hr size='1'>";
    echo "<br>";
    echo "<b>Usuario: </b> admin@adminmayor<br>";
    echo "<b>Contrasena: </b> admin<br>";
//    echo getRealIpAddr();
    echo "<br>";
...
else 
{
    ...
    echo "<br>";
    echo "Recomiendo <b>Google Chrome</b> puede descargarlo <a href='http://www.google.com/chrome/eula.html' title='Descargar Google Chrome'>aqui</a> o visite la pagina <a href='http://www.google.com/chrome'>http://www.google.com/chrome</a>";
    echo "<br>";
