...
public class listacobrocuenta {
    ...
    //private ToolbarButton anularcobro;
   ...
   // private Store store;
    ...
    String estilo = "";
    private Panel panel;
    private ColumnConfig idcreditoColumn;
   ...
   // private Object[][] vendedorM;
    ...
    String[] nombreCaso5Columns = {"idventa", "idmarca", "fechaventa", "boleta", "cajas", "pares", "montodeuda", "rebaja", "pagado", "pardev", "susdev", "porpagar", "fechaultimopago", "fechamaxima", "estado", "detalle", "marca", "idcrecliente"};
  ...
  //rivate Object[][] estiloM;
    ...
    public void onModuleLoad5(String idcuent,String idmarca, String idkardex, String idtiend) {
        panel = new Panel();
        ...
        recordDef = new RecordDef(new FieldDef[]{
                    ...
                    new StringFieldDef(nombreCaso5Columns[15]),
                    new StringFieldDef(nombreCaso5Columns[16]),
                    new StringFieldDef(nombreCaso5Columns[17])
                });
        //pogo
     ...
     //   GroupingStore store
        ...
        codigoColumn = new ColumnConfig("Venta", nombreCaso5Columns[2], 85, true);
        colorColumn = new ColumnConfig("Boleta", nombreCaso5Columns[3],69, true);
        ...
        precioColumn = new ColumnConfig("Sus", nombreCaso5Columns[6], 60, true);
        rebajaColumn = new ColumnConfig("Rebaja", nombreCaso5Columns[7], 70, true);
        talla33Column = new ColumnConfig("Pagado", nombreCaso5Columns[8], 75, true, null);
        talla34Column = new ColumnConfig("DevPar", nombreCaso5Columns[9], 75, true, null);
        talla35Column = new ColumnConfig("DevSus", nombreCaso5Columns[10], 75, true, null);
        talla36Column = new ColumnConfig("Por Pagar", nombreCaso5Columns[11], 95, true, null);
        talla37Column = new ColumnConfig("Ultimo Pago", nombreCaso5Columns[12], 115, true, null);
        talla38Column = new ColumnConfig("Fecha Limite", nombreCaso5Columns[13], 115, true, null);
        talla39Column = new ColumnConfig("Estado", nombreCaso5Columns[14], 100, true, null);
        talla40Column = new ColumnConfig("detalle", nombreCaso5Columns[15], 100, true, null);
        talla45Column = new ColumnConfig("Marca", nombreCaso5Columns[16],100, true, null);
        idcreditoColumn = new ColumnConfig("idcredito", nombreCaso5Columns[17],100, true, null);
        ...
        grid.setTitle("Cuentas agrupadas por Marca");
...
//        anularcobro = new ToolbarButton("Anular Cobros/Rebajas");
//        anularcobro.setEnableToggle(true);
//        QuickTipsConfig tipsConfig212 = new QuickTipsConfig();
//        tipsConfig212.setText("anular");
//        anularcobro.setTooltip(tipsConfig212);

        editarventa = new ToolbarButton("Editar Venta");
        editarventa.setEnableToggle(true);
        QuickTipsConfig tipsConfig2123 = new QuickTipsConfig();
        tipsConfig2123.setText("Editar");
        editarventa.setTooltip(tipsConfig2123);
        ...
        pagingToolbar.addSeparator();
//        pagingToolbar.addButton(anularcobro);
//        pagingToolbar.addSeparator();
    ...
    private void aniadirListenersProducto() {
        ...
        cambiarestilo.addListener(new ButtonListenerAdapter() {
            ...
            public void onClick(Button button, EventObject e) {
                ...
                if (records.length == 1) {                    
                    selecionado = records[0].getAsString("idcrecliente");
                    //MessageBox.alert("idventa ", selecionado + " crecliente " + selecionado2);
                    String enlTemp = "funcion=verpagos&idcrecliente=" + selecionado;
                    //MessageBox.alert("devuelve ", enlTemp);
                    verReporte(enlTemp);
                } else {
                    MessageBox.alert("No hay Venta selecionada para ver detalle y/o selecciono mas de uno.");
                }
        ...
        @Override
            public void onClick(Button button, EventObject e) {
                ...
                if (records.length == 1) {
                    ...
                    MessageBox.alert("No selecciono ninguna cuenta");
                }
