 ...
 * @author example
 */
public class ListaCalzadoPedidoTalla {
 ...
 //   private MaterialPedido materialpedido;
    ...
    public void onModuleLoad1() {
        ...
        recordDef = new RecordDef(new FieldDef[]{
                    ...
                    new StringFieldDef(nombreCaso5Columns[26]),
                    new StringFieldDef(nombreCaso5Columns[27])
                });
       ...
       // colorColumn = new ColumnConfig("Color", nombreCaso5Columns[3], 100, true);
        ...
        totalcajasColumn = new ColumnConfig("Num", nombreCaso5Columns[6], 40, true, null);
        precioColumn = new ColumnConfig("Precio", nombreCaso5Columns[7],80, true);
         preciounitarioColumn = new ColumnConfig("Precio", nombreCaso5Columns[8], 60, true);
         talla = new ColumnConfig("M/W", nombreCaso5Columns[9], 50, true);

       talla5Column = new ColumnConfig("5", nombreCaso5Columns[10], 35, true, null);
        talla5mColumn = new ColumnConfig("5m", nombreCaso5Columns[11], 35, true, null);
        talla6Column = new ColumnConfig("6", nombreCaso5Columns[12], 35, true, null);

      talla6mColumn = new ColumnConfig("6m", nombreCaso5Columns[13], 35, true, null);
        talla7Column = new ColumnConfig("7", nombreCaso5Columns[14], 35, true, null);
        talla7mColumn = new ColumnConfig("7m", nombreCaso5Columns[15], 35, true, null);
        talla8Column = new ColumnConfig("8", nombreCaso5Columns[16], 35, true, null);
        talla8mColumn = new ColumnConfig("8m", nombreCaso5Columns[17], 35, true, null);
        talla9Column = new ColumnConfig("9", nombreCaso5Columns[18], 35, true, null);
        talla9mColumn = new ColumnConfig("9m", nombreCaso5Columns[19], 35, true, null);
        talla10Column = new ColumnConfig("10", nombreCaso5Columns[20], 35, true, null);
        talla10mColumn = new ColumnConfig("10m", nombreCaso5Columns[21], 35, true, null);
        talla11Column = new ColumnConfig("11", nombreCaso5Columns[22], 35, true, null);
        talla11mColumn = new ColumnConfig("11m", nombreCaso5Columns[23], 35, true, null);
        talla12Column = new ColumnConfig("12", nombreCaso5Columns[24], 35, true, null);

        totalparesColumn = new ColumnConfig("Total", nombreCaso5Columns[25], 80, true, null);
        totalparescajaColumn = new ColumnConfig("pares  x", nombreCaso5Columns[26], 80, true, null);
        totalparesbsColumn = new ColumnConfig("Total", nombreCaso5Columns[27], 80, true, null);
