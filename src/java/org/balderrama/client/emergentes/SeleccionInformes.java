 ...
 * @author 
 */
public class SeleccionInformes extends Window {
...
private Button but_traspaso;
  ...
  //  Pedido ped;
   ...
   private DateField dat_fechaini1109;
    ...
    public SeleccionInformes(Object[][] marca,Object[][] estilo, KMenu kmenu) {
        padre=kmenu;
      //  panel=pan;
        ...
        vendedorM =estilo;
        //kmenu = menu;
        String tituloTabla = "Reportes cobros-Ventas Resumen Cliente-";
        this.setClosable(true);
        this.setId("TPfun30042");
        setIconCls("tab-icon");
        setAutoScroll(false);
  ...
  dat_fechaini1109 = new DateField("Fecha Inicio", "Y-m-d",200);
        ...
        dat_fechafin1109.setValue(fechahoy);
          ...
          String nombreBoton3 = "Ver ventas confirmadas";
          String nombreBoton44 = "Ver Pagos";
          //String nombreBoton444 = "Ver ventas confirmadas";
        String nombreBoton2 = "Cancelar";
    String nombreBoton4 = "Ver reporte Resumen";
     
//        String nombreBoton31 = "Recibidos";
//          String nombreBoton313 = "Ingresos X Inventario";
...
//         but_aceptarPp = new Button(nombreBoton444, new ButtonListenerAdapter() {
//            @Override
...
//      String enlace = "funcion=verventalistaconfirmada&idmarca=" + idmarca + "&idvendedor="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
//      verReporte(enlace);
//           }
//        });
         but_aceptarCl = new Button(nombreBoton3, new ButtonListenerAdapter() {
            @Override
            public void onClick(Button button, EventObject e) {
                 ...
                 String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
                 String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
                 String enlace = "funcion=pormarcavendedorcobrodetallevendedor&idcliente=" + idmarca+ "&fecha1=" +fecha1 + "&fecha2="+ fecha2;
       verReporte(enlace);
            }
        });
 ...
 but_reportemodelo = new Button(nombreBoton44, new ButtonListenerAdapter() {
        ...
        String idestilo = com_estilo.getValue();
         String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
           String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
       String enlace = "funcion=verresumen&idmarca=" + idmarca + "&idvendedor="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
               verReporte(enlace);
           }
        });
     but_reporte = new Button(nombreBoton4, new ButtonListenerAdapter() {
        ...
        String idestilo = com_estilo.getValue();
         String fecha1 = DateUtil.format(dat_fechaini1109.getValue(), "Y-m-d");
           String fecha2 = DateUtil.format(dat_fechafin1109.getValue(), "Y-m-d");
       String enlace = "funcion=verresumenCXC&idmarca=" + idmarca + "&idvendedor="+ idestilo +"&fecha1=" +fecha1 + "&fecha2="+ fecha2;
               verReporte(enlace);
        ...
        but_cancelarP = new Button(nombreBoton2, new ButtonListenerAdapter() {
            ...
            @Override
            public void onClick(Button button, EventObject e) {
                SeleccionInformes.this.destroy();
                SeleccionInformes.this.close();
