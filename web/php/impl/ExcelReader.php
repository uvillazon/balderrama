    ...
    */
        ...
        if($res === false) {
            ...
            if($this->_ole->error == 1) {
                ...
                die('El archivo ' . $sFileName . ' No se pudo cargar, tenga en cuenta que su archivo no puede contener imagenes ni otros objetos que no sean datos basicos en la tabla. Disculpe las molestias causadas'.$this->_ole->error);
            }
